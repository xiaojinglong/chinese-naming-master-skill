# -*- coding: utf-8 -*-
"""山水·苇舟系报告：延续意境派方向，文言动词句式（望/见/若/以）+ 山水意象，八字优先计分"""
import sys, os
...
# 山水·苇舟系：金属性意象字（川/山/星/青/然/思/叙）全部排除——犯忌神；
# 「苇=木、洲/源/溪/渊/深/航=水」，水生木帮扶乙木日主，苇洲/苇航出自《诗经·河广》"一苇杭之"。
FINAL_NAMES = ['陈苇洲', '陈望源', '陈以深', '陈苇航',
               '陈见溪', '陈见源', '陈若渊']
...
result = {
    'input': {'surname': '陈', 'gender': 'male',
              ...
              'requirement': '山水·苇舟系取名：延续用户认可的意境派方向（画面感+低重名+八字补水底线）。金属性意象字（川/山/星/青/然）犯忌神全部排除；核心组合「苇+洲/航」出自《诗经·卫风·河广》"谁谓河广，一苇杭之"与苏轼《赤壁赋》"纵一苇之所如"；八字优先计分，五格仅参考'},
    'bazi': bazi.to_dict(),
    'xiyongshen': xiyong, 'jiyongshen': jiyong, 'zodiac': zodiac,
    'candidates': final,
}
out_path = os.path.join(BASE, 'batch_reports', 'chen_shanshui_report.html')

...
# 甜点区名单：用字熟悉顺口（非冷门）、组合不烂大街、补水避金、五格吉
FINAL_NAMES = ['陈沁泽', '陈牧泽', '陈泓清', '陈以清', '陈慕泽',
               '陈明泽', '陈佳泽', '陈以淮']
...
result = {
    'input': {'surname': '陈', 'gender': 'male',
              ...
              'requirement': '甜点区取名：用字熟悉顺口（听感现代、非冷门字），但组合避开热名（沐泽/宇泽/浩宇等）；命理标准不降——补水抑火、避忌神金、五格吉，双水组合优先'},
    'bazi': bazi.to_dict(),
    'xiyongshen': xiyong, 'jiyongshen': jiyong, 'zodiac': zodiac,
    'candidates': final,
}
out_path = os.path.join(BASE, 'batch_reports', 'chen_sweetspot_report.html')
